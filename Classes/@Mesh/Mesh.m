classdef Mesh < handle
    ...
    methods
        function obj = Mesh(Domain,BC,RefiningOptions)
            ...
            %   Detailed explanation goes here
            addpath('Classes/@Mesh/Triangolatore/Long/bbtr30/')
        ...
        function el = getEl(obj,refElement,e)
            if length(obj.elements)<e
                coordinates=obj.geom.elements.coordinates(obj.geom.elements.triangles(e,1:3),:);
                el=Element(coordinates,refElement);
                obj.elements{e}=el;
                return
            end
            el=obj.elements{e};
